...
# Création d'un registre pour les métriques
registry = CollectorRegistry()
# Définir le Gauge pour MAE
mae_gauge = Gauge('model_mae', 'Mean Absolute Error du modèle', ['model_name'], registry=registry)
# Définir le Gauge pour RMSE
rmse_gauge = Gauge('model_rmse', 'Root Mean Square Error du modèle', ['model_name'], registry=registry)
